...
/*   Updated: 2023/01/31 20:55:34 by okassimi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (pos.check == -2)
		return (0);
	pos.buffer = ft_strjoin(pos.buffer, sta[fd]);
	...
	pos.line = ft_substr(pos.buffer, 0, pos.j + 1);
	sta[fd] = ft_strchr(pos.buffer, '\n');
	sta[fd] = ft_substr(pos.buffer, pos.j + 1, ft_strlen(sta[fd]));
